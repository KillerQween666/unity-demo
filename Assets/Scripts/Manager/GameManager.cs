...
public class GameManager : MonoBehaviour {
    ...
    // 游戏启动时执行
    private void Start() {
        AudioManager.Instance.PlayBgm(Config.bgm3); // 播放初始背景音乐
        GameStart(); // 触发游戏开始流程
    }
